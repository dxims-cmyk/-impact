        ...
        <div ref={ref} className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <motion.div
            ...
            className={`rounded-2xl border-2 p-6 sm:p-8 transition-colors duration-700 ${
              dark ? 'border-[#E8642C]/30 bg-[#E8642C]/[0.03]' : 'border-[#E8642C]/20 bg-[#E8642C]/[0.02]'
            }`}
          >
            <div className="flex items-center gap-2 mb-6">
              <div className="w-8 h-8 rounded-lg flex items-center justify-center bg-[#E8642C]/10">
                <Check className="w-4 h-4 text-[#E8642C]" />
              </div>
              <h3 className={`font-display text-lg font-bold transition-colors duration-700 ${
                dark ? 'text-white' : 'text-[#0B1220]'
              }`}>
                With <span className="text-[#E8642C]">:</span>Impact
              </h3>
            </div>
            <div className="space-y-4">
              {withItems.map((item, i) => (
                <motion.div
                  ...
                  className="flex items-start gap-3"
                >
                  <item.icon className="w-4 h-4 mt-0.5 shrink-0 text-[#E8642C]" />
