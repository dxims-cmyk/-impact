            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className={`w-9 h-9 rounded-lg flex items-center justify-center transition-all duration-300 ${
                  dark ? 'bg-zinc-900 hover:bg-zinc-800 text-zinc-400 hover:text-white' : 'bg-gray-100 hover:bg-gray-200 text-gray-600 hover:text-[#0B1220]'
                }`}
              ...
              <a
                href="https://www.linkedin.com/company/mediampm"
                target="_blank"
                rel="noopener noreferrer"
                className={`w-9 h-9 rounded-lg flex items-center justify-center transition-all duration-300 ${
                  dark ? 'bg-zinc-900 hover:bg-zinc-800 text-zinc-400 hover:text-white' : 'bg-gray-100 hover:bg-gray-200 text-gray-600 hover:text-[#0B1220]'
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className={`inline-flex items-center gap-1.5 px-3 h-9 rounded-lg text-xs font-semibold transition-all duration-300 ${
                  dark ? 'bg-zinc-900 hover:bg-zinc-800 text-zinc-400 hover:text-white' : 'bg-gray-100 hover:bg-gray-200 text-gray-600 hover:text-[#0B1220]'
                }`}
              >
                AM:PM Media
                ...
                <li key={item.href}>
                  <a
                    ...
                    className={`text-sm font-medium transition-colors duration-300 ${
                      dark ? 'text-zinc-400 hover:text-white' : 'text-[#0B1220] hover:text-[#6E0F1A]'
                    }`}
                  >
                    {item.label}
                  </a>
